...
class SelectCategoriesPopUp extends HookWidget {
  const SelectCategoriesPopUp({Key key}) : super(key: key);
                                                  ...
                                                  child: Ink(
                                                    ...
                                                    child: InkWell(
                                                      onTap: () {
                                                        ...
                                                        print(
                                                            'ui ${newPath} , the thing ${stateF.choosenCatagories}');
                                                        if (newPath.length <
                                                            3) {
                                                          context
                                                              .bloc<
