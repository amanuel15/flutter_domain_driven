...
Widget selectImagePopup(BuildContext context, ProductFormState stateF) {
                    ...
                    imageUploadSuccessFailure.imageUploadSuccessFailure.fold(
                        ...
                        FlushbarHelper.createError(
                          ...
                          message: failure
                              .maybeWhen(
                                ...
                                uploadFailed: () => "Image Failed To Upload",
                      ...
                      (success) => {
                        ...
                        if (imageUploadSuccessFailure.imageType == "LandScape")
                          ...
                          {
                            context.bloc<ProductFormBloc>().add(
                                  ProductFormEvent.portraitSelected(success),
                                ),
                          },
                        //validateEntity(),
                      },
                ...
                children: <Widget>[
                  ...
                  Column(
                    children: <Widget>[
                      ...
                      stateF.selectedImages.isNotEmpty
                          ? CarouselSlider(
                            ...
                            GestureDetector(
                              ...
                              child: IconShadowWidget(
                                Icon(
                                  ...
                                  color: const Color.fromRGBO(25, 25, 25, 0.7),
                                  size: 0.03.hp.toDouble(),
                                ),
                                showShadow: true,
                              ),
